...
cp ./wrt_plugin_src/src_CMakeLists.txt /prj/wrt-plugins-ivi/wrt-plugins-ivi-0.13.0/src/
rm /prj/wrt-plugins-ivi/wrt-plugins-ivi-0.13.0/src/CMakeLists.txt
mv /prj/wrt-plugins-ivi/wrt-plugins-ivi-0.13.0/src/src_CMakeLists.txt /prj/wrt-plugins-ivi/wrt-plugins-ivi-0.13.0/src/CMakeLists.txt
