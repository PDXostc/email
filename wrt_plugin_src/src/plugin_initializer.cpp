...
void on_widget_start_callback(int widgetId) {
	LoggerD("[TIZEN\\emailplugin guru] on_widget_start_callback ("<<widgetId<<")");
	Try
	{
...
void on_widget_stop_callback(int widgetId) {
	LoggerD("[TIZEN\\emailplugin guru] on_widget_stop_callback ("<<widgetId<<")");
	Try
	{
...
PLUGIN_CLASS_MAP_ADD_CLASS(WRT_JS_EXTENSION_OBJECT_TIZEN,
		"emailplugin",
		(js_class_template_getter)JSEmailplugin::getClassRef,
		NULL)
